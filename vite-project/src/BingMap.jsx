...
const MapComponent = () => {
    ...
    function clickHandler(e) {
        ...
        Microsoft.Maps.loadModule('Microsoft.Maps.Directions', () => {
            ...
            const directionsManager = new Microsoft.Maps.Directions.DirectionsManager(mapRef.current);
    ...
    return (
        <div style={{ position: 'relative' }}>
            ...
            <div ref={mapContainerRef} id="myMap" style={{ width: '100%', height: '780px' }}></div>
        </div>
    );
};
